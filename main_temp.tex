...
This year the team had the chance to improve the AI software design which is the core program runing on a desktop or copmuter laptop and is the means to navigate each robot. The robots robots move and take actions which are defined by this program. Other enhancements, however, have been continued to be made to the robots mechanics and electonics which will be explained in further sections.
