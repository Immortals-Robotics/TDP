...
% TODO for Omid: explain the issues with FSMs in more detail here
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.5\textwidth}|p{6cm}|}
        ...
        \\
        {\itshape CircleBall(radius, angle)} & Returns a position on a circle around the ball at a specific angle.\\
        \hline
    \end{tabular}
\end{table}
